...
client.on('messageCreate', async Message => {
    ...
    if (Command == 'setup') {
        ...
        const Embed = new EmbedBuilder()
            ...
            .setDescription(`Click the buttons below to control your voice channel\n**Button Usage**\n${emojis.lock} — [\`Lock\`](${link}) the voice channel\n${emojis.unlock} — [\`Unlock\`](${link}) the voice channel\n${emojis.hidechannel} — [\`Hide\`](${link}) the voice channel\n${emojis.UnhideChannel} — [\`Unhide\`](${link}) the voice channel\n${emojis.RenameChannel} — [\`Rename\`](${link}) the voice channel\n${emojis.Mute} — [\`Mute\`](${link}) a member\n${emojis.unmute} — [\`Unmute\`](${link}) a member\n${emojis.customize} — [\`Customize\`](${link}) the user limit \n${emojis.Disconnect} — [\`Disconnect\`](${link}) all Members\n${emojis.UsersManager} — [\`Control\`](${link}) your channel\n${emojis.Delete_Channel} — [\`Delete\`](${link}) Your Channel`)
        ...
        .addComponents(
            ...
            new ButtonBuilder()
                .setStyle(ButtonStyle.Secondary)
                .setEmoji(emojis.hidechannel)
                .setCustomId('HideChannel'),
            new ButtonBuilder()
                .setStyle(ButtonStyle.Secondary)
                .setEmoji(emojis.UnhideChannel)
                .setCustomId('UnhideChannel'),
            new ButtonBuilder()
                .setStyle(ButtonStyle.Secondary)
                .setEmoji(emojis.RenameChannel)
    ...
    const RowTwo = new ActionRowBuilder()
        .addComponents(
            ...
            new ButtonBuilder()
                .setStyle(ButtonStyle.Secondary)
                .setEmoji(emojis.customize)
                .setCustomId('Customize_UserLimit'),
            new ButtonBuilder()
                .setStyle(ButtonStyle.Secondary)
                .setEmoji(emojis.Disconnect)
                .setCustomId('Disconnect'))
    const RowThree = new ActionRowBuilder()
        .addComponents(
            new ButtonBuilder()
                .setStyle(ButtonStyle.Secondary)
                .setEmoji(emojis.UsersManager)
                .setCustomId('UsersManager'),
            new ButtonBuilder()
                .setStyle(ButtonStyle.Secondary)
                .setEmoji(emojis.Delete_Channel)
